...
-- 7. 更新现有用户表（添加部门关联）
ALTER TABLE `ys_user` 
ADD COLUMN `dept_id` BIGINT DEFAULT NULL COMMENT '部门ID' AFTER `dep_id`,
...
(105, 3, '新增角色', 'system:role:add', 2, 1, 1),
(106, 3, '编辑角色', 'system:role:edit', 2, 1, 2),
(107, 3, '删除角色', 'system:role:delete', 2, 1, 3),
(108, 3, '查询角色', 'system:role:query', 2, 1, 4),
(109, 3, '分配权限', 'system:role:assign', 2, 1, 5);
