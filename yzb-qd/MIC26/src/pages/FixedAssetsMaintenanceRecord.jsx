...
import { Card, Table, Input, Select, DatePicker, Button, Space, Tag, Modal, Form, message, Row, Col } from 'antd';
          ...
          <Row gutter={[16, 16]} style={{ width: '100%' }}>
            ...
            <Col xs={24} sm={12} md={8} lg={6}>
              <Form.Item label="维修类型">
                <Select placeholder="请选择维修类型" style={{ width: '100%' }}>
                  <Option value="all">全部类型</Option>
            ...
            <Col xs={24} sm={12} md={8} lg={6}>
              <Form.Item label="维修状态">
                <Select placeholder="请选择维修状态" style={{ width: '100%' }}>
            ...
            <Col xs={24} sm={12} md={8} lg={6}>
              <Form.Item label="维修日期">
                <RangePicker placeholder={['维修开始日期', '维修结束日期']} style={{ width: '100%' }} />
              </Form.Item>
            </Col>
