...
const TransferAcceptance = () => {
  ...
  const transferAcceptanceColumns = [
    { title: '调拨单号', dataIndex: 'transferNumber', key: 'transferNumber', width: 150 },
    ...
    { title: '调拨数量', dataIndex: 'quantity', key: 'quantity', width: 100 },
    { title: '单位', dataIndex: 'unit', key: 'unit', width: 80 },
    { title: '调拨日期', dataIndex: 'transferDate', key: 'transferDate', width: 120 },
    { title: '调拨人', dataIndex: 'transferor', key: 'transferor', width: 100 },
    { title: '验收状态', dataIndex: 'acceptanceStatus', key: 'acceptanceStatus', width: 120, render: (status) => {
      const statusMap = {
    ...
    { title: '验收数量', dataIndex: 'acceptedQuantity', key: 'acceptedQuantity', width: 100 },
    { title: '验收人', dataIndex: 'acceptor', key: 'acceptor', width: 100 },
    { title: '验收日期', dataIndex: 'acceptanceDate', key: 'acceptanceDate', width: 120 },
    { 
      title: '操作', 
      key: 'action',
      width: 200,
                ...
                <table style={{ width: '100%', borderCollapse: 'collapse', minWidth: '900px' }}>
                  <thead style={{ backgroundColor: '#f0f0f0' }}>
                    <tr>
                      ...
                      <th style={{ padding: '12px 8px', textAlign: 'left', whiteSpace: 'nowrap' }}>商品名称</th>
                      <th style={{ padding: '12px 8px', textAlign: 'left', whiteSpace: 'nowrap' }}>规格型号</th>
                      <th style={{ padding: '12px 8px', textAlign: 'left', whiteSpace: 'nowrap' }}>批号</th>
                      <th style={{ padding: '12px 8px', textAlign: 'right', whiteSpace: 'nowrap' }}>数量</th>
                      <th style={{ padding: '12px 8px', textAlign: 'left', whiteSpace: 'nowrap' }}>单位</th>
                      <th style={{ padding: '12px 8px', textAlign: 'left', whiteSpace: 'nowrap' }}>生产日期</th>
                      <th style={{ padding: '12px 8px', textAlign: 'left', whiteSpace: 'nowrap' }}>有效期</th>
                    </tr>
                  </thead>
                  <tbody>
                    {selectedItems.map(item => (
                      <tr key={item.key} style={{ borderBottom: '1px solid #f0f0f0' }}>
                        ...
                        <td style={{ padding: '12px 8px', whiteSpace: 'nowrap' }}>{item.materialName}</td>
                        <td style={{ padding: '12px 8px', whiteSpace: 'nowrap' }}>{item.specification}</td>
                        <td style={{ padding: '12px 8px', whiteSpace: 'nowrap' }}>{item.batchNumber}</td>
                        <td style={{ padding: '12px 8px', textAlign: 'right', whiteSpace: 'nowrap' }}>{item.quantity}</td>
                        <td style={{ padding: '12px 8px', whiteSpace: 'nowrap' }}>{item.unit}</td>
                        <td style={{ padding: '12px 8px', whiteSpace: 'nowrap' }}>{item.productionDate}</td>
                        <td style={{ padding: '12px 8px', whiteSpace: 'nowrap' }}>{item.expiryDate}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
