...
import { getNoteByPage, saveNote } from '../utils/noteStorage';
...
export const NoteProvider = ({ children }) => {
  ...
  const [isNoteWindowVisible, setIsNoteWindowVisible] = useState(true);
  ...
  const toggleNoteWindow = useCallback(() => {
    setIsNoteWindowVisible(!isNoteWindowVisible);
  }, [isNoteWindowVisible]);
